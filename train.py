...
import pytorch_ssim
import MDN
from VH_ADL import VH_AE as ae
import argparse
...
#model.load_state_dict(torch.load('/gpfsscratch/rech/ohv/ueu39kt/MNIST_Norm0/VH_AE_MNIST0_bs16.pt'))
...
#         torch.nn.utils.clip_grad_norm_(G_estimate.parameters(), max_norm=2.0, norm_type=2)
    ...
    if np.mean(t_loss) <= minloss:
        ...
        ep = i
        os.makedirs('/gpfsscratch/rech/ohv/ueu39kt/HaloNetMNIST_Norm0_MDN', exist_ok=True)
        torch.save(model.state_dict(), f'/gpfsscratch/rech/ohv/ueu39kt/HaloNetMNIST_Norm0_MDN/VH_AE_MNIST0_bs16'+'.pt')
        torch.save(G_estimate.state_dict(), f'/gpfsscratch/rech/ohv/ueu39kt/HaloNetMNIST_Norm0_MDN/G_estimate_MNIST0_bs16_'+'.pt')
